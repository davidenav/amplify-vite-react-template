...
import { createContractRequests } from "./graphql/mutations";
const client = generateClient();
export default function ContractRequestsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setResponseText(initialValues.responseText);
    setErrors({});
  };
  const validations = {
    type: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createContractRequests.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ContractRequestsCreateForm")}
      {...rest}
    >
      <SelectField
        label="Type"
